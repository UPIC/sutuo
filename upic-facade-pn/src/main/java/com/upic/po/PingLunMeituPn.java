...
public class PingLunMeituPn extends BaseEntity {
	...
	public PingLunMeituPn() {
		super();
	}

	public PingLunMeituPn(String userId, String meituPnId, String status, String content, String field1, String field2,
