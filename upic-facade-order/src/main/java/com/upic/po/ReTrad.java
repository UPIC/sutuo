 ...
 * @版本:V1.0
 */
public class ReTrad extends BaseEntity implements Serializable {
	...
	public String toString() {
		...
		sb.append(", editor=").append(this.getEditor());
		sb.append(", creater=").append(this.getCreater());
		sb.append(", editTime=").append(this.getEditTime());
