...
public class EmailConst {
	...
	/** 机构审核不通过 **/
	public static String Training_NOTPASS = "template/email/AgentTrainingAuditNotPassToTraining.vm";
	/** 机构审核通过 **/
	public static String Training_PASS = "template/email/AgentTrainingAuditPassToTraining.vm";
	
	/** 公司审核不通过 **/
	public static String Unit_NOTPASS = "template/email/AgentUnitAuditNotPassToUnit.vm";
	/** 公司审核通过 **/
	public static String Unit_PASS = "template/email/AgentUnitAuditPassToUnit.vm";
	
	/** 公司审核不通过 **/
	public static String Teacher_NOTPASS = "template/email/AgentTeacherAuditNotPassToTeacher.vm";
	/** 公司审核通过 **/
	public static String Teacher_PASS = "template/email/AgentTeacherAuditPassToTeacher.vm";
	
	/** 课程审核不通过 **/
	public static String ClassUpload_NOTPASS = "template/email/AgentClassUploadAuditNotPassToClassUpload.vm";
	/** 课程审核通过 **/
	public static String ClassUpload_PASS = "template/email/AgentClassUploadAuditPassToClassUpload.vm";
