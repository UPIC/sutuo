...
<div class="pageContent">
	<form id="form" method="post" action="moduleList_insert.action"
		...
		<div class="pageFormContent" layoutH="60">
			<p style="width: 99%">
				<label>模版编号：</label> <input name="num" value="" type="number"
					cssClass="required" />
			</p>
			<p style="width: 99%">
			...
			<p style="width: 99%">
				<label>跳转地址：</label> <input name="forwordAddress" cssClass="required"
