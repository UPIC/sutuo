	...
	<form id="pagerForm" onsubmit="return navTabSearch(this);"
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<li><a href="hotThemePnLink_readyInsert.action" title="添加"
		...
		<tbody>
			<s:iterator value="recordList" status="st">
				<tr target="sid_user" rel="${id}">
					...
					<td>${title}</td>
					<td>${articalPnName}</td>
					<td>[<a href="hotThemePnLink_readyUpdate.action?id=${id}" title="更新"
						target="dialog" width="550" height="300" rel="input"
						style="color: blue">更新</a>]&nbsp;&nbsp; [<a
						href="hotThemePnLink_deleteHotThemePn.action?id=${id}" title="确认【删除】"
