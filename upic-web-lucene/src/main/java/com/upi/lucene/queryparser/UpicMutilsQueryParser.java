package com.upi.lucene.queryparser;
...
public class UpicMutilsQueryParser extends QueryParser {
	 ...
	 * </p>
	 */
	public UpicMutilsQueryParser(String[] fields, Analyzer analyzer, Map<String, Float> boosts) {
	 ...
	 * </p>
	 */
	public UpicMutilsQueryParser(String[] fields, Analyzer analyzer) {
		super(null, analyzer);
		this.fields = fields;
	}
	...
	protected Query getFieldQuery(String field, String queryText, boolean quoted) throws ParseException {
		if (field == null) {
			...
			for (int termNum = 0; termNum < maxTerms; termNum++) {
				List<Query> termClauses = new ArrayList<Query>();
				for (int i = 0; i < fields.length; i++) {
	...
	protected Query getFuzzyQuery(String field, String termStr, float minSimilarity) throws ParseException {
		System.err.println("敏感格式：" + termStr);
	...
	/** Creates a multifield query 创建多查询 */
