package com.upic.pay.common.web.springmvc;
...
import com.upic.common.utils.string.StrUtil;
import com.upic.common.utils.string.StringUtil;
import com.upic.common.web.utils.UdpGetClientMacAddr;
 ...
 */
@Controller
public class SpringMvcControllerSupport {

	private static final long serialVersionUID = 1L;

	private static final Log LOG = LogFactory.getLog(SpringMvcControllerSupport.class);
	 ...
	 * @param result
	 */
	public void outWrite(Object result) {
		PrintWriter out = null;
		try {
			response.setCharacterEncoding("utf-8");
			out = response.getWriter();
	...
	/**
	 * 给不是从页面提交跳转提供类似于下面的参数
	 * <input type="hidden" name="navTabId" value="list"> <input type="hidden"
	 * name="callbackType" value="closeCurrent"> <input type="hidden" name=
	 * "forwardUrl" value="">
	 * 
	 * @param str1
	 * @param str2
	...
	public void oprateparameter(String str1, String str2) {
		...
		request.setAttribute("navTabId", "list");
		request.setAttribute("callbackType", str1);
		request.setAttribute("forwardUrl", str2);
	}
...
//	}
	 ...
	 * @return
	 */
	public PageParam getPageParam(String pageNumStr, String numPerPageStr) {
		int numPerPage = 20;
		int pageNum = 1;
