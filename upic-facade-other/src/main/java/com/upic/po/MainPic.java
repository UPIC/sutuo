...
public class MainPic extends BaseEntity implements Comparable<MainPic>{
	...
	public MainPic(String url, int picNumber, String field1, String field2, String field3, String field4, String field5,
			String picType, String forwordType, String forwordId) {
		super();
		this.url = url;
	...
	@Override
	public int compareTo(MainPic o) {
