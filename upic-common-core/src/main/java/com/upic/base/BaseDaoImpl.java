...
import com.upic.common.core.mybatis.interceptor.ExecutorInterceptor;
import com.upic.common.entity.BaseEntity;
import com.upic.common.exceptions.BizException;
...
public abstract class BaseDaoImpl<T extends BaseEntity> extends SqlSessionDaoSupport implements BaseDao<T> {
	...
	public long update(T t,String method) {
		if (t == null)
			throw new RuntimeException("T is null");

		int result = sessionTemplate.update(getStatement(method), t);
