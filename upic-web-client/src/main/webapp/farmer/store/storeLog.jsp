...
<script type="text/javascript">
	function getContent() {
		...
		var urls = "${ctx}/log/listLog/"+storeIds+"/"+pageNumStrs+"/"+numPerPageStrs+".do";
		$
				.ajax({
					type : "POST",
					url : urls,
	...
	function addHtml(data) {
			...
			for (var i = 0; i < data.length; i++) {
				htmls += "<a href='${ctx}/log/getLog/"+data[i].logNumber+".do'><div class='big'>";
				htmls += "<div class='box1'>"+data[i].articName+"</div>";
				htmls += "<div class='box2'>" + data[i].title
						+ "</div>";
