...
<script type="text/javascript">
	...
	function addComment() {
		...
		$.ajax({
			type : "POST",
			url : "${ctx}/comment/userReflect.do",
...
<body>
	<div class="headerbox">
		...
		<div class="am-header-left am-header-nav">
			<a href="${ctx}/init/initIndex.do" class="" style="color: gray"> 首页 </a>
		</div>

		<div class="am-header-title" style="color: black">您的宝贵意见</div>

		<div class="am-header-right am-header-nav">
			<a href="#" onclick="addComment()" class=""
				style="color: gray"> 提交</a>
		</div>
		</header>
	</div>
	<div class="main">
...
<!-- 		</ul> -->
	...
	<div>
	<img src="${upic}/assets/i/dilog.png" width="375" height="375"/>
	</div>
</body>
</html>