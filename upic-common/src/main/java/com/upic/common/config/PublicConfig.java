 ...
 */
package com.upic.common.config;

import java.util.Map;

import com.upic.common.utils.ResourceUtils;
...
public class PublicConfig {
	 ...
	 * 微信支付文件配置 加载。
	 */
	public static Map<String, String> WEIXIN_PAY = ResourceUtils.getResource("wechat_pay").getMap();
	/**
	 * OSS文件上传
	 */
	public static Map<String, String> OSS_FILE = ResourceUtils.getResource("service").getMap();
	 ...
	 * 搜索回调地址
	 */
	public final static String SEARCH_URL = PUBLIC_SYSTEM.get("SEARCH_URL");
	/**
	 * 搜索企业回调地址
	 */
	public final static String SEARCH_TRAIN_URL = PUBLIC_SYSTEM.get("SEARCH_TRAIN_URL");
	/**
	 * 二级页面多条件查询
	 */
	public final static String SEARCH_CLASS = PUBLIC_SYSTEM.get("SEARCH_CLASS");
	/**
	 * 搜索引擎关键字
	 */
	public final static String SEARCH_KEWORD = PUBLIC_SYSTEM.get("SEARCH_KEWORD");
	/**
	 * 是否开发状态
	 */
	 ...
	 * 微信公众号 appid
	 */
	public final static String APPID = WEIXIN_PAY.get("appid");
	/**
	 * appsecret
	 */
	public final static String APPSECRET = WEIXIN_PAY.get("appsecret");
	/**
	 * 微信商户号
	 */
	public final static String PARTNER = WEIXIN_PAY.get("partner");
	/**
	 * 商户号Key
	 * partnerkey
	 */
	public final static String PARTNERKEY = WEIXIN_PAY.get("partnerkey");
	 ...
	 * endpoint 上海 
	 */
	public final static String ENDPOINT_SHANGHAI = OSS_FILE.get("endpointShanghai");
	/**
	 * accessKeyId Img
	 */
	public final static String ACCESSKEYID_IMG = OSS_FILE.get("accessKeyIdImg");
	/**
	 * accessKeySecret  Img
	 */
	public final static String ACCESSKEYSECRET_IMG = OSS_FILE.get("accessKeySecretImg");
	/**
	 * bucketName  Img
	 */
	public final static String BUCKETNAME_IMG = OSS_FILE.get("bucketNameImg");
}
